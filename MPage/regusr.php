...
$newUser = new user($_POST['unam'],$_POST['upas'],$_POST['cnfp'],$_POST['ueml'],$_POST['utel'],$_POST['frnm'],$_POST['lsnm']);
...
class user{
	...
	function __construct($usrName,$usrPass,$usrCnfp,$usrEmal,$usrTele,$usrFrnm,$usrLsnm){
	...
	$dbName   = "furtwenty_tester2";
		...
		usrname, password, email, phone, fname, lname
		) VALUES (
		'$this->usrName','$usrPass','$this->usrEmal','$this->usrTele','$this->usrFrnm','$this->usrLsnm')";
